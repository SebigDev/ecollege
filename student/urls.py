...
urlpatterns = [
    ...
    url(r'^my-enrolled-courses/$', views.students_courses, name='my_courses'),
    url(r'^start-enrolled-course/(?P<pk>\d+)/(?P<slug>[\w-]+)/$',
        views.student_take_course, name='student_take_course'),
